	...
	return(
		<div className="AboutPage">
			...
			<div>
				...
				<p id={id}>Magdalena and I had been dumpster diving around Brooklyn and Manhattan for over a year when we decided to create an <a id={id} href="https://www.instagram.com/trash.pandas_ofnyc/?hl=en">instagram account</a> in 2019 to document the quantity (and quality) of all the things we were finding in the trash. Toothpaste. Candy bars. Razors. Feminine hygeine products. Crackers and dry goods. Holiday items, decorations and treats. And so much more!</p>
				...
				<p id={id}>But if this is the trend for the tiny CVS and Walgreens in the little sliver of New York that we covered, imagine this trend magnified across the city, the country, the entire global market!</p>
